...
public class UsuarioModificarUsuariosAdapter extends RecyclerView.Adapter<UsuarioModificarUsuariosAdapter.UsuarioViewHolder> {
    ...
    public void onBindViewHolder(@NonNull UsuarioViewHolder holder, int position) {
        ...
        holder.textViewModificarUsuario.setOnClickListener(v -> mostrarDialogoModificacion(usuario));
    }
    ...
    private void mostrarDialogoModificacion(Usuario usuario) {
        ...
        builder.setView(view)
                ...
                .setPositiveButton("Guardar", (dialog, which) -> {
                    ...
                    if (usuarioConsulta.actualizarUsuario(usuario)) {
                        // Si la actualización fue exitosa, actualizar la vista en el RecyclerView
                        notifyDataSetChanged();
                    } else {
                        Snackbar.make(view, "No se ha podido actualizar el usuario", Snackbar.LENGTH_LONG).show();
                    }
                })
